...
extension Color {
    ...
    static let shoulder = Color(#colorLiteral(red: 0.7158692479, green: 0.6330819726, blue: 0.9852458835, alpha: 1))
    static let arm = Color(#colorLiteral(red: 0.9893369079, green: 0.5322159529, blue: 0.1008731201, alpha: 1))
}
